...
namespace Rebus.ServiceProvider
{
    ...
    /// </summary>
    [StepDocumentation("Adds the service provider to the incoming step context, thus making it available for the rest of the pipeline.")]
    public class ServiceProviderProviderStep : IIncomingStep
    {
